/*
    threadwork_server1.c

    Concurrently receive byte-sized numbers from clients.
    Add the numbers to a list using mutexes.

    To make delete operations stupid simple, do it like this:
    If I get a number N between 1 and 50 inclusive, then add
    it to the list. If the number N is 51 to 100 inclusive,
    take that to mean delete the number (N-50). E.g.

    50 = add the number 50 to the list.
    51 = delete the number 1 from the list.
*/
...
int main(void){
    ...
    while(1) { // main accept() loop
        ...
        // Thread this shit up.
        /*
            I need to run a function here that will need
            new_fd, and a pointer to the list.
