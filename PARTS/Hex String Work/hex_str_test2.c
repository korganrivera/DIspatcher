/*
    Testing out hex_string(), a function that turns a data blob 
    into a character string of hex values, separated by spaces.
    
    e.g.
    0d0e0f101112 -> "0D 0E 0F 10 11 12"
*/
...
char* hex_to_char(uint8_t n){
/* Takes a byte value, returns that 
   value as a string. e.g. F5 -> "F5"
*/
...
void hex_string(char *str, uint8_t *data, uint32_t length){
/* Takes a data blob, converts it to a
   string of hex values. Assumes str
